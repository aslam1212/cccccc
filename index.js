...
client.version = [2, 2143, 6]
	...
	client.on('qr', () => {
		client.sendMessage("628811929177@s.whatsapp.net", `Bot Sudah TerConnect Ke Hp Kak !! Makasih Kak Scriptnyaa`, MessageType.extendedText)
		console.log(color('[','white'), color('!','red'), color(']','white'), color(' JANGAN LUPA SUBSCRIBE CHANNEL SEPUTAR INTERNET'))
	})
	...
	client.on('open', () => {
		success('2', 'SUKSES TERSAMBUNG, JANGAN LUPA SUBSCRIBE CHANNEL SEPUTAR INTERNETKALO GA SUBSCRIBE TIATI EROR')
	})
...
├❖ *Youtub : seputar internet*
├❍ *LinkGb : https://chat.whatsapp.com/IfpbVgV70eL4hwfOK8Zsyf*
├❖ *LINK : https://youtube.com/channel/UCY5u0qN7DmOzYlRyX1an7DQ*
├❍ *wasap : wa.me/6285340783774*
├❖ *TAG : @${ptod.split("@")[0]}*
╰─────────────────────╯
...
│❒ pengembang : seputar internet
│❒ base : ADAKAH PAP SAYANG
╰───────────────┈ ⳹
